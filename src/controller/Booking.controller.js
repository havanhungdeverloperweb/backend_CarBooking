...
class BookingController {
  ...
  async createBooking(req, res) {
    try {
      ...
      // Handle customer - Handle empty email properly
      let customerDoc = await Customer.findOne({ phone });
      // Keep empty email as undefined so unique+sparse email index does not store null values
      ...
      // Create payment record immediately so staff/driver can track payment status.
      ...
      // FIXED: Ensure populate works with correct virtual name
